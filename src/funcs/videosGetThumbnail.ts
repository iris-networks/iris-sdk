 ...
 */
export function videosGetThumbnail(
  client: IrisSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetRecordingThumbnailRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/videos/{id}/thumbnail")(pathParams);
